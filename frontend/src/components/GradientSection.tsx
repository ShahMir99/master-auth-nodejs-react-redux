...
const GradientSection = () => {
  return (
    <div className="bg-gradient-to-br from-[#00c4cc] to-[#7d2ae8]">
      <div className="h-10 bg-white rounded-br-3xl rounded-bl-3xl" />
      <div className="px-12 py-24">
        <div className="mx-auto max-w-[1500px] bg-white p-24 rounded-3xl">
          <div className="mb-28">
            <h1 className="text-center text-neutral-900 text-5xl font-semibold">
              Where big dreams come to life
            </h1>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="pt-4 flex flex-col gap-6 items-start">
              ...
              <p className="text-lg text-neutral-700 font-normal">
                Redefine the way you create with Magic Studio, our suite of
                AI-powered tools that generate copy in your brand voice with
                Magic Write and transform your photos with Magic Edit.
              </p>
              <button className="border py-2 px-4 rounded-lg text-base border-gray-300 font-medium">
                Discover now
              </button>
            </div>
          ...
          <div className="mt-20 grid grid-cols-2 gap-12">
            <div className="w-full h-[370px] bg-[#fee6fe] rounded-2xl overflow-hidden">
              <div className="w-full h-full relative pl-6">
                <img
                  src="/images/benefits-together.jpg"
                  alt="benefits-together"
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
            <div className="pt-4 flex flex-col gap-6 items-start">
              ...
              <p className="text-lg text-neutral-700 font-normal">
                ...
                comment and work in real-time on Presentations, Whiteboards,
      ...
      <div className="h-10 bg-white rounded-tr-3xl rounded-tl-3xl" />
    </div>
  );
};
